...
const log = (0, logger_1.createLogger)("postgres");
// Single connection pool shared across all modules.
exports.pool = new pg_1.Pool({
    connectionString: config_1.config.db.postgres || undefined,
    // Fallback for local dev when DATABASE_URL is not set
    host: config_1.config.db.postgres ? undefined : "localhost",
    port: config_1.config.db.postgres ? undefined : 5432,
    database: config_1.config.db.postgres ? undefined : "bioscan",
    max: 20,
